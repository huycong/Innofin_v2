...
public class Request {
    ...
    public static Response send(String url, String method, Map<String, Object> headers) {
        RestAssuredConfig config = getConfig();
        RequestSpecification rs = RestAssured.given()
                .log()
                .all()
    ...
    public static Response send(String url, String method, String contentType, String body_json, Map<String, Object> body) {
        //RestAssuredConfig config = getConfig();
        RequestSpecification rs = RestAssured.given();
    ...
    public static Response send(String url, String method, Map<String, Object> headers, String contentType, String body_json, Map<String, Object> body) {
        RequestSpecification rs = RestAssured.given();
